...
declare module 'styled-components' {
  ...
  export type InterpolationValue = string | number | FalseyValue | Keyframes | StyledComponentInterpolation;
  ...
  export type GlobalStyleComponent<P extends { theme?: T | undefined }, T> = React.ComponentClass<ThemedGlobalStyledClassProps<P, T>>
  ...
  > extends ForwardRefExoticBase<StyledComponentProps<C, T, O, A>> {
    ...
    >;
    withComponent<WithC extends keyof JSXIntrinsicElementsMinimal | React.ComponentType<any>>(
        component: WithC,
  ...
  export type StyledFunction<C extends keyof JSXIntrinsicElementsMinimal | React.ComponentType<any>> = ThemedStyledFunction<
    C,
    any
  >;
  ...
  export interface BaseThemedCssFunction<T extends object> {
    ...
    <P extends object>(
        first: TemplateStringsArray | InterpolationFunction<ThemedStyledProps<P, T>>,
...
export type ThemedCssFunction<T extends object> = BaseThemedCssFunction<AnyIfEmpty<T>>;
  ...
  export interface ThemedStyledComponentsModule<T extends object, U extends object = T> {
    ...
    keyframes: (strings: TemplateStringsArray, ...interpolations: SimpleInterpolation[]) => Keyframes;
  ...
  */
  ...
  export function createGlobalStyle<P extends object = {}>(
    first: TemplateStringsArray | InterpolationFunction<ThemedStyledProps<P, DefaultTheme>>,
